...
function Button({ children, disabled, to , type}) {
    ...
    const styles = {
        secondary: "focus:outline-none border-2 border-stone-300 focus:ring-offset-2 focus:ring focus:ring-yellow-300 focus:bg-yellow-300 duration-300 transition-colors uppercase font-semibold   text-stone-800 inline-block  tracking-wide rounded-full hover:bg-yellow-300 disabled:cursor-not-allowed ",
