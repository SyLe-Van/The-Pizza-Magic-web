...
function Button({ children, disabled, to , type}) {
    ...
    const styles = {
        secondary: "focus:outline-none border-2 py-2.5 px-4 md:px-6 md:py-3.5 border-stone-300 focus:ring-offset-2 focus:ring focus:ring-yellow-300 focus:bg-yellow-300 duration-300 transition-colors uppercase font-semibold   text-stone-400 inline-block  tracking-wide rounded-full hover:bg-stone-800 disabled:cursor-not-allowed ",
